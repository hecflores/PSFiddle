...
namespace MC.Track.TestSuite.Proxies
{
    public class FunctionProxy: IFunctionProxy
    {
        ...
        public FunctionProxy(Type type, MemberInfo method, IEventBasedProxy eventBasedProxy, IResolver resolver)
        {
            this.Type = type ?? throw new ArgumentNullException(nameof(type));
            this.Method = method ?? throw new ArgumentNullException(nameof(method));
            this.eventBasedProxy = eventBasedProxy ?? throw new ArgumentNullException(nameof(eventBasedProxy));
            this.smartResourceDestroyerServiceFactory = resolver.Resolve<ISmartResourceDestroyerServiceFactory>();
        }
