...
namespace MC.Track.TestSuite.Proxies.FunctionalOverrides.NTP.Models
{
    public class UserAgreementStatus8503ChangesType
    {
        /// <summary>
        ...
        /// Is Marketing Track
        /// </summary>
        public bool IsMarketingTrack { get; set; }
        /// <summary>
        /// Is Maketing Product
        /// </summary>
        public bool IsMarketingProduct { get; set; }
