...
{
    public class UIQuerablePOMParsedElement : SimpleElementPOMParsedElement
    {
        public UIQuerablePOMParsedElement(POMParsingContext context, HtmlNode htmlElement, POMParsedRawElement parent, POMParsingRule parsableDefinition, string element, string name, string selector)
