...
namespace PSFiddle.UIAutomation.POM.Models.POMParsingRules.CustomRules
{
    ...
    public class PartialRenderingPOMParsingRule : BasicPOMParsingRule
    {
        private string _Format = @"\@Html.Partial\(""~(.*?)""";

        public PartialRenderingPOMParsingRule(POMParsingContext pOMParsingContext) : base(pOMParsingContext, "ui-readable", typeof(UIReadablePOMParsedElement))
        {
        }
